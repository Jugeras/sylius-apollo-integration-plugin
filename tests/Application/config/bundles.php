...
return [
    ...
    PrintPlius\SyliusB2BPlugin\PrintPliusSyliusB2BPlugin::class => ['all' => true],
    PrintPlius\SyliusIceCatIntegrationPlugin\PrintPliusSyliusIceCatIntegrationPlugin::class => ['all' => true],
    PrintPlius\SyliusCarrierPlusPlugin\PrintPliusSyliusCarrierPlusPlugin::class => ['all' => true],
];
